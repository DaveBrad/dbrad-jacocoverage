...
public final class SingleSETD {
	...
	public static HashMap<Class<? extends OtdAddXyz>, String> getResetDataFor(){
	 ...
	 /**
	 * ATDI method _v0_validatePkgFilterTable_JavaLibraryTestModel1
	 * @param acfpiObj the parent OTD object
	 * @return an ATDI OTD object
	 */
	public static TableOtd _v0_validatePkgFilterTable_JavaLibraryTestModel1(TableOtd acfpiObj){
 
		TableOtd atdiObj = new TableOtd();
 
		atdiObj.methodData( "_v0_validatePkgFilterTable_JavaLibraryTestModel1", "JavaLibraryTestModel1", acfpiObj );
